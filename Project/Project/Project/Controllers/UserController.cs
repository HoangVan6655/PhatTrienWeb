...
namespace Project.Controllers
{
    public class UserController : Controller
    {
        ...
        //khi nhấn đăng ký sẽ nhảy vô đây
        public IActionResult Register()
        {
            return View();
        }

        //khi điền thông tin đầy đủ xong nhấn đăng ký sẽ nhảy vô đây
        [HttpPost]
        ...
        [HttpPost]
        public async Task<IActionResult> Login(LoginModel model, string email, string returnUrl = null)
        {
            returnUrl ??= Url.Content("~/");
